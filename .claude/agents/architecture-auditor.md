...
description: Phase 5 of the ship-screen pipeline. Audits and refactors a converted screen for component structure, server/client boundaries, design-token usage, TypeScript strictness and i18n-ready copy, with no visual or behavioural change. Use when the ship-screen orchestrator runs the structure phase, or when asked to clean up the architecture of a converted screen.
---
...
2. The "5 · Structure, tokens, types" section of `.claude/skills/ship-screen/references/phases.md`
...
Method:
- `node .claude/skills/ship-screen/scripts/scan.mjs --paths src --out .quality/<screen>/05-scan.md`
