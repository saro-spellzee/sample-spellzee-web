...
2. The "9 · Security" section of `.claude/skills/ship-screen/references/phases.md`
...
Method:
- Baseline: `npm run build`, then `node .claude/skills/ship-screen/scripts/audit.mjs --routes <route> --checks headers,console --out .quality/<screen>/09-audit`,
