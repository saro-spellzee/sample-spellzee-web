    ...
    >
      <defs>
        <linearGradient id={id} x1="0" y1="0" x2="1" y2="0">
          <stop offset="0" stopColor={s.stops[0]} stopOpacity="0.15" />
          <stop offset="0.5" stopColor={s.stops[1]} stopOpacity="0.55" />
          <stop offset="1" stopColor={s.stops[2]} stopOpacity="0.15" />
        </linearGradient>
      </defs>
      <path d={s.fill} fill="#FCF8F4" />
